...
public class CustomListAdapterUsersDialog extends BaseAdapter {

    private ArrayList<UserBoard> listData;

    private LayoutInflater layoutInflater;

    private Context mContext;

    public CustomListAdapterUsersDialog(Context context, ArrayList<UserBoard> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CustomListAdapterAssigneeDialog.ViewHolder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.list_row_dialog, null);
            holder = new CustomListAdapterAssigneeDialog.ViewHolder();
            ...
            holder = (CustomListAdapterAssigneeDialog.ViewHolder) convertView.getTag();
        }
