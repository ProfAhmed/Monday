...
public class NotificationRepository {
    ...
    public NotificationRepository(Application mContext) {
        this.mContext = mContext;
    }

    private Gson gson = new Gson();

    public StateLiveData<BasicResponse<NotificationData>> getNotifications(String url) {

        StateLiveData<BasicResponse<NotificationData>> boardsResponseStateLiveData = new StateLiveData<>();
                ...
                JsonObjectRequest(Request.Method.GET,
                        ...
                        response -> {
                            try {
                                ...
                                if (successful) {
                                    Type dataType = new
                                            TypeToken<BasicResponse<NotificationData>>() {
                                            }.getType();
                                    BasicResponse<NotificationData> data =
