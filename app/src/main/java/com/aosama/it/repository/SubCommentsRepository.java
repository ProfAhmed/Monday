...
public class SubCommentsRepository {
    ...
    public SubCommentsRepository(Application mContext) {
    ...
    public StateLiveData<BasicResponse<CommentGroup>> getSubComments(String url) {
        ...
        StateLiveData<BasicResponse<CommentGroup>> boardsResponseStateLiveData = new StateLiveData<>();
                ...
                JsonObjectRequest(Request.Method.GET,
                        ...
                        response -> {
                            try {
                                ...
                                if (successful) {
                                    Type dataType = new
                                            TypeToken<BasicResponse<CommentGroup>>() {
                                            }.getType();
                                    BasicResponse<CommentGroup> data =
